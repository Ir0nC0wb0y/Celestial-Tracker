...
#define HALFSTEP 8
  ...
  #define PIN_EL_A 33 // Connected pin for El motor, IN1  was 27
  #define PIN_EL_B 25 // Connected pin for El motor, IN3  was 26
  #define PIN_EL_C 26 // Connected pin for El motor, IN2  was 25
  #define PIN_EL_D 27 // Connected pin for El motor, IN4  was 33

  #define PIN_H_AZ 35 // Connected to SIG pin of Az Endstop
  #define PIN_H_EL 34 // Connected to SIG pin of El Endstop

  #define HOME_OFF_AZ  10.0  // Offset in homing for Az
  #define HOME_OFF_EL -30.0  // Offset in homing for El
#endif
